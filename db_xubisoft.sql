...
(1, 'Post Graduation', NULL, NULL),
(2, 'Graduation', NULL, NULL),
(3, 'Diploma', NULL, NULL),
(4, 'Others', NULL, NULL);
...
--
-- Table structure for table `father_working_statuses`
--

CREATE TABLE `father_working_statuses` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `father_working_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `father_working_statuses`
--

INSERT INTO `father_working_statuses` (`id`, `father_working_status`, `created_at`, `updated_at`) VALUES
(1, 'Business', NULL, NULL),
(2, 'Job Holder', NULL, NULL),
(3, 'None', NULL, NULL);
...
--
-- Table structure for table `mother_working_statuses`
--

CREATE TABLE `mother_working_statuses` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `mother_working_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `mother_working_statuses`
--

INSERT INTO `mother_working_statuses` (`id`, `mother_working_status`, `created_at`, `updated_at`) VALUES
(1, 'Job Holder', NULL, NULL),
(2, 'House Wife', NULL, NULL),
(3, 'None', NULL, NULL);
...
CREATE TABLE `seips` (
  ...
  `alt_phone` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Indexes for table `father_working_statuses`
--
ALTER TABLE `father_working_statuses`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `mother_working_statuses`
--
ALTER TABLE `mother_working_statuses`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `father_working_statuses`
--
ALTER TABLE `father_working_statuses`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
