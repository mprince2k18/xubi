                        ...
                        <div class="courses_single_container">
                            ...
                            <div class="cs_row_two">
                                <div class="cs_overview b0p0">
                                    ...
                                    <p class="mb30 text-left">{{ $single_training_details->course_description }}</p>
                                    <h4 class="subtitle">What you'll learn</h4>
                                    <ul class="cs_course_syslebus">
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_1 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_2 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_3 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_4 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_5 }}</p>
                                        </li>
                                    </ul>
                                    <ul class="cs_course_syslebus2">
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_6 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_7 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_8 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_9 }}</p>
                                        </li>
                                        <li><i class="fa fa-check"></i>
                                            <p>{{ $single_training_details->what_u_will_learn_10 }}</p>
                                        </li>
                                    </ul>
                                    <h4 class="subtitle">Requirements</h4>
                                    <ul class="list_requiremetn">
                                        <li><i class="fa fa-circle"></i>
                                            <p>{{ $single_training_details->requirements_1 }}</p>
                                        </li>
                                        <li><i class="fa fa-circle"></i>
                                            <p>{{ $single_training_details->requirements_2 }}</p>
                                        </li>
                                        <li><i class="fa fa-circle"></i>
                                            <p>{{ $single_training_details->requirements_3 }}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div id="panelBodyCourseStart" class="panel-collapse collapse show">
                                                    <div class="panel-body">
                                                        <ul class="cs_list mb0">
                                                            {{-- <li><a href="#"><span class="flaticon-play-button-1 icon"></span> {{ $single_training_details->lecture_title_1 }} <span class="cs_time">02:53</span> <span
                            ...
                            {{-- <div class="cs_row_four">
  									<div class="about_ins_container b0p0">
  										...
  										<div class="about_ins_info">
  											<div class="thumb"><img src="{{ asset('custom/images/team/6.png') }}" alt="6.png">
                        </div>
                    </div>
                    <div class="details">
                        ...
                        <p class="mb25">Skills: Web Design, UI Design, UX/UI Design, Mobile Design, User Interface Design, Sketch, Photoshop, GUI, Html, Css, Grid Systems, Typography, Minimal, Template, English, Bootstrap, Responsive Web Design,
                            Pixel Perfect, Graphic Design, Corporate, Creative, Flat, Luxury and much more.</p>
