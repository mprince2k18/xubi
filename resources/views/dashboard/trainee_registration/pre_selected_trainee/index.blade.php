        ...
        <div class="main">
				...
				<div class="main-content">
					<div class="row">
                      ...
                      @foreach ($pre_selected_trainees as $pre_selected_trainee)
                        <tr>
                          <td>{{ $pre_selected_trainee->trainee_id }}</td>
                          <td>{{ $pre_selected_trainee->quarter_id }}</td>
                          <td>{{ $pre_selected_trainee->name }}</td>
                          <td>{{ $pre_selected_trainee->email }}</td>
                          <td>{{ $pre_selected_trainee->phone }}</td>
                          <td>{{ $pre_selected_trainee->university }}</td>
                          <td>{{ $pre_selected_trainee->nid }}</td>
                          {{-- <td>{{ $pre_selected_trainee->rocket_number === ' ' ? $pre_selected_trainee->rocket_number : 'Null'  }}</td> --}}
                          <td>

                            {{ $pre_selected_trainee->relationBetweenEducation->education_qualification }}

                          </td>
                          <td>
                            {{ $pre_selected_trainee->relationBetweenWork->working_status }}
                          </td>
                          <td>
                            {{ $pre_selected_trainee->relationBetweenSeip->seip_status }}
                          </td>
                          <td>
                            {{ $pre_selected_trainee->relationBetweenRemarks->remarks_status }}
                          </td>
                          <td>
                              <a href="{{ '/admin/trainee' }}/{{ $pre_selected_trainee->id }}" class="btn btn-primary">open</a>
                          </td>
                        </tr>
                      @endforeach
