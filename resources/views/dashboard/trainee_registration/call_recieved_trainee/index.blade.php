        ...
        <div class="main">
				...
				<div class="main-content">
					<div class="row">
                      ...
                      @foreach ($call_recieved_trainees as $call_recieved_trainee)
                        <tr>
                          <td>{{ $call_recieved_trainee->trainee_id }}</td>
                          <td>{{ $call_recieved_trainee->quarter_id }}</td>
                          <td>{{ $call_recieved_trainee->name }}</td>
                          <td>{{ $call_recieved_trainee->email }}</td>
                          <td>{{ $call_recieved_trainee->phone }}</td>
                          <td>{{ $call_recieved_trainee->university }}</td>
                          <td>{{ $call_recieved_trainee->nid }}</td>
                          {{-- <td>{{ $call_recieved_trainee->rocket_number === ' ' ? $call_recieved_trainee->rocket_number : 'Null'  }}</td> --}}
                          <td>

                            {{ $call_recieved_trainee->relationBetweenEducation->education_qualification }}

                          </td>
                          <td>
                            {{ $call_recieved_trainee->relationBetweenWork->working_status }}
                          </td>
                          <td>
                            {{ $call_recieved_trainee->relationBetweenSeip->seip_status }}
                          </td>
                          <td>
                            {{ $call_recieved_trainee->relationBetweenRemarks->remarks_status }}
                          </td>
                          <td>
                              <a href="{{ '/admin/trainee' }}/{{ $call_recieved_trainee->id }}" class="btn btn-primary">open</a>
                          </td>
                        </tr>
                      @endforeach
