        ...
        <div class="main">
				...
				<div class="main-content">
					<div class="row">
                      ...
                      @foreach ($did_not_picked_trainees as $did_not_picked_trainee)
                        <tr>
                          <td>{{ $did_not_picked_trainee->trainee_id }}</td>
                          <td>{{ $did_not_picked_trainee->quarter_id }}</td>
                          <td>{{ $did_not_picked_trainee->name }}</td>
                          <td>{{ $did_not_picked_trainee->email }}</td>
                          <td>{{ $did_not_picked_trainee->phone }}</td>
                          <td>{{ $did_not_picked_trainee->university }}</td>
                          <td>{{ $did_not_picked_trainee->nid }}</td>
                          {{-- <td>{{ $did_not_picked_trainee->rocket_number === ' ' ? $did_not_picked_trainee->rocket_number : 'Null'  }}</td> --}}
                          <td>

                            {{ $did_not_picked_trainee->relationBetweenEducation->education_qualification }}

                          </td>
                          <td>
                            {{ $did_not_picked_trainee->relationBetweenWork->working_status }}
                          </td>
                          <td>
                            {{ $did_not_picked_trainee->relationBetweenSeip->seip_status }}
                          </td>
                          <td>
                            {{ $did_not_picked_trainee->relationBetweenRemarks->remarks_status }}
                          </td>
                          <td>
                              <a href="{{ '/admin/trainee' }}/{{ $did_not_picked_trainee->id }}" class="btn btn-primary">open</a>
                          </td>
                        </tr>
                      @endforeach
