                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="what_u_will_learn_5" placeholder="5.">
                                                ...
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="what_u_will_learn_10" placeholder="10.">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="requirements_3" placeholder="3.">
                                                ...
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="requirements_6" placeholder="6.">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="lecture_title_5" placeholder="5.">
                                                ...
                                                <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="lecture_title_10" placeholder="10.">
                                                                                      ...
                                                                                      <div class="form-group">
                                                                                        ...
                                                                                        <div class="row">
                                                                                          <div class="col-md-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="resources_3" placeholder="3.">
                                                                                          ...
                                                                                          <div class="col-md-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="resources_6" placeholder="6.">
                                                                                      ...
                                                                                      <div class="form-group">
                                                                                        ...
                                                                                        <div class="row">
                                                                                          <div class="col-md-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="course_features_5" placeholder="course_features_5">
                                                                                          ...
                                                                                          <div class="col-md-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="course_features_5_item" placeholder="course_features_5_item">
