...
class CreateServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->string('title_watermark_full');
            // title end

            // about_service
            $table->string('about_service_title');
            $table->longText('details_about_service');
            // about service end

            // service_info_1
            $table->string('service_info_banner')->nullable();
            $table->longText('service_info_details')->nullable();
